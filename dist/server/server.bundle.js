...
var express = __webpack_require__(/*! express */ "express");
var _require = __webpack_require__(/*! ../middlewares/env */ "./server/middlewares/env/index.js"),
  publicEnvMiddleware = _require.publicEnvMiddleware;
var _require2 = __webpack_require__(/*! ../api/auth */ "./server/api/auth/index.js"),
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var UserResponse = __webpack_require__(/*! ../../models/UserResponse */ "./server/models/UserResponse.js");
...
/* harmony import */ var _utils_genericError__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/genericError */ "./server/utils/genericError.js");
...
var errorResponseHandler = function errorResponseHandler(error) {
  try {
    ...
    var invalidTokenResponseMessages = error === null || error === void 0 || (_error$response2 = error.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.messages) === null || _error$response2 === void 0 ? void 0 : _error$response2.find(function (x) {
      return typeof x === 'string' && x.includes(_utils_genericError__WEBPACK_IMPORTED_MODULE_1__.INVALID_TOKEN);
    });
    var invalidTokenResponseCode = code === _utils_genericError__WEBPACK_IMPORTED_MODULE_1__.INVALID_TOKEN;
...
var _require2 = __webpack_require__(/*! ./api */ "./server/api/index.js"),
...
app.listen(PORT, function () {
  console.log("BFF Shell listening on http://localhost:".concat(PORT));
});
})();
